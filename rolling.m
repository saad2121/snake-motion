 ...
 clientID=vrep.simxStart('127.0.0.1',19997,true,true,5000,5);
  if (clientID>-1)
      ...
      for t=1:100
           av1= (pi/6)*sin((pi/6)*t+1*2*pi/2+pi/6);
           av2= (pi/6)*sin((pi/6)*t+3*2*pi/2+pi/6);
           av3= (pi/6)*sin((pi/6)*t+5*2*pi/2+pi/6);
           av4= (pi/6)*sin((pi/6)*t+7*2*pi/2+pi/6);
           
           ah1= (pi/6)*sin((pi/6)*t+2*2*pi/2);
           ah2= (pi/6)*sin((pi/6)*t+4*2*pi/2);
           ah3= (pi/6)*sin((pi/6)*t+6*2*pi/2);
           ah4= (pi/6)*sin((pi/6)*t+8*2*pi/2);
